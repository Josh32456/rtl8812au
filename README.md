...
```
Note: There is a regression with the TP-Link AC600 and potenically other devices. Currently the work around is to pull from a previous comment. Please see [this comment](https://github.com/aircrack-ng/rtl8812au/issues/1159#issuecomment-2169928358)
